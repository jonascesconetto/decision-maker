...
const polls = [
  {id: 1, admin_email: 'a@b.com', title: 'Lunch Suggestions', admin_url:'abcdef', vote_url:'uvwxyz', question: 'where do we go for lunch?', is_active:true},
  {id: 2, admin_email: 'b@c.com', title: 'Movie Suggestions', admin_url:'lorem', vote_url:'ipsum', question: 'What movie can we watch next week?', is_active:true},
  {id: 3, admin_email: 'd@e.com', title: 'Weekend plans', admin_url: 'minim', vote_url:'tempor', question: 'What shall we do this weekend?', is_active:false}
]
